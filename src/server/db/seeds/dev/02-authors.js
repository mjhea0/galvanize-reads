exports.seed = function(knex, Promise){
  return Promise.all([
    ...
    var updatedAuthorIDs = authorIDs.map(function(currentId){
      return currentId[0];
    });
    var bookAuthors = [{
      bookTitle: 'Python In A Nutshell',
      authorId: updatedAuthorIDs[0]
    },{
      bookTitle: 'Python In A Nutshell',
      authorId: updatedAuthorIDs[1]
    },{
      bookTitle: 'Python In A Nutshell',
      authorId: updatedAuthorIDs[2]
    },{
      bookTitle: 'Think Python',
      authorId: updatedAuthorIDs[3]
    },{
      bookTitle: 'Learning React Native',
      authorId: updatedAuthorIDs[4]
    },{
      bookTitle: 'You Don\'t Know JS',
      authorId: updatedAuthorIDs[5]
    }];
