exports.seed = function(knex, Promise) {
  return Promise.all([
    ...
    var bookAuthors = [
      ...
      {
        bookTitle: 'Algorithms in a Nutshell',
        authorID: authorIDs[5]
      },
      {
        bookTitle: 'The Ruby Programming Language',
      ...
      {
        bookTitle: 'AngularJS: Up and Running',
        authorID: authorIDs[8]
      },
      {
        bookTitle: 'Web Development with Node and Express',
        authorID: authorIDs[9]
      },
      {
        bookTitle: 'Think Java',
        authorID: authorIDs[10]
      },
      {
        bookTitle: 'Lightweight Django',
        authorID: authorIDs[11]
      }
    ];
